...
categories =  ['P01','P02','P03','P04','P05','P06','P07','P08','P09','P10']  # 카테고리 이름 
dictionary_size = 50                        # 사전 크기, 클러스터 갯수 
base_path = "../img/TS/M1/"  # 학습 이미지 기본 경로 
dict_file = './pose_dict.npy'         # 사전 객체 저장할 파일 이름 
svm_model_file = './pose_svm.xml'     # SVM 모델 객체 저장할 파일 이름 
